...
// MPFR 2.4.0 Specifics
    ...
    friend const mpreal urandom (gmp_randmStatet& state, mp_rnd_t rnd_mode);     // use gmp_randinit_default() to init state, gmp_randclear() to clear
#endif

#if (MPFR_VERSION >= MPFR_VERSION_NUM(3,1,0))
    friend const mpreal grandom (gmp_randmStatet& state, mp_rnd_t rnd_mode);     // use gmp_randinit_default() to init state, gmp_randclear() to clear
    ...
    friend const mpreal urandomb (gmp_randmStatet& state);
...
inline const mpreal urandomb (gmp_randmStatet& state)
{
    mpreal x;
...
#if (MPFR_VERSION >= MPFR_VERSION_NUM(3,0,0))
inline const mpreal urandom (gmp_randmStatet& state, mp_rnd_t rnd_mode = mpreal::get_default_rnd())
{
    mpreal x;
...
inline const mpreal grandom (gmp_randmStatet& state, mp_rnd_t rnd_mode = mpreal::get_default_rnd())
{
    mpreal x;
